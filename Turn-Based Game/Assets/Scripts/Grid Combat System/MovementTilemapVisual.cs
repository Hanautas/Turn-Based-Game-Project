...
public class MovementTilemapVisual : MonoBehaviour {
    ...
    private void Awake() {
        ...
        float textureWidth = 1000f;
        float textureHeight = 1000f;
    ...
    private void Grid_OnGridValueChanged(object sender, GridSystem<MovementTilemap.TilemapObject>.OnGridValueChangedEventArgs e) {
        updateMesh = true;
    }
